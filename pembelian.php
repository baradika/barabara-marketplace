            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if($row['id_pengiriman'] > 0): ?>
                        <a href="index.php?halaman=pembayaran&id=<?php echo $row['id_pembelian']; ?>"> 
                        <button class="btn amber">pembayaran</button></a>
                    <?php endif; ?>
                </td>
            </tr>
        <?php 
...
<div align="right">
    <ul class="pagination">
        ...
        ?>
            <li class="active"><a href="index.php?halaman=pembelian&page=<?php echo $LinkPrev; ?>">
        ...
        ?>
            <li class="waves-effect"><?php echo $linkActive; ?>
            <a href="index.php?halaman=pembelian&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php } ?>
        <?php       
        if ($page == $jumlahPage) { 
        ?>
        ...
        ?>
            <li><a href="index.php?halaman=pembelian&page=<?php echo $linkNext; ?>">
