...
<body>
  ...
  <ul class="sidenav sidenav-fixed" id="slide-out">
    <li class="text-center">
        <!-- Check if the session variable is set, otherwise use a default image -->
        <img src="../assets/img/admin/<?php echo isset($_SESSION['admin']['foto_admin']) && !empty($_SESSION['admin']['foto_admin']) ? $_SESSION['admin']['foto_admin'] : 'default.jpg'; ?>" class="user-image img-responsive" />
        <h5 class="brown-text"><?php echo htmlspecialchars($_SESSION['admin']['nama_lengkap']); ?></h5>
    </li>
